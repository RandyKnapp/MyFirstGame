// MyFirstGame.cpp : Defines the entry point for the application.
//
...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    MSG msg;
	LARGE_INTEGER lastTick, currentTick, frequency;
	...
	while (!game.IsExiting())
	{
		...
		LONGLONG tickDifference = currentTick.QuadPart - lastTick.QuadPart;
		double elapsedSeconds = tickDifference * (1.0 / frequency.QuadPart);
